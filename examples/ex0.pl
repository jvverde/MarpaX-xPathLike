...
print '----self----';
print $d->query(q|//0//*/self::0|)->getvalues();
print $d->query(q|//0//*/self::[0][not(*)]|)->getvalues();
print $d->query(q|//0//*/self::{0}|)->getvalues();
print '----child----';
print $d->query(q|/*/*//child::0|)->getvalues();
print $d->query(q|/*/*//0|)->getvalues();
print $d->query(q|/*/*//child::[0]|)->getvalues();
print $d->query(q|/*/*//[0]|)->getvalues();
print $d->query(q|/*/*//child::{0}|)->getvalues();
print $d->query(q|/*/*//{0}|)->getvalues();
print '----*----';
print $d->query(q|//*[not(*)]|)->getvalues();
print $d->query(q|//[*][not(*)]|)->getvalues();
print $d->query(q|//{*}[not(*)]|)->getvalues();
print '----keyname----';
print $d->query(q|/b|)->getvalues();
